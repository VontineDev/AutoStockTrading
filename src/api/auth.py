...
def get_kiwoom_env():
    ...
    """
    use_mock = False
    if STREAMLIT_MODE and hasattr(st, 'session_state') and 'USE_KIWOOM_MOCK' in st.session_state:
...
def get_access_token(API_KEY: str, API_SECRET: str, base_url: str = "https://api.kiwoom.com", timeout: int = 30) -> Optional[str]:
    """
...
def revoke_access_token(API_KEY: str, API_SECRET: str, access_token: str, base_url: str = "https://api.kiwoom.com", timeout: int = 30) -> bool:
    """
...
if __name__ == "__main__":
    ...
    token = get_access_token(kiwoom_env['api_key'], kiwoom_env['api_secret'], base_url=kiwoom_env['base_url'])
    if token:
